...
var modals = function modals() {
  function bindModal(btnClick, modal, closeBtn) {
    var callEngineerbtn = document.querySelector(btnClick);
    var modalEngineer = document.querySelector(modal);
    var modalEngineerClose = document.querySelector(closeBtn);
    callEngineerbtn.addEventListener('click', function (e) {
      if (e.target) {
        e.preventDefault();
      }
